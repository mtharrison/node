...
Before Node.js hands off your module to be executed by V8, it wraps the entire thing in a function wrapper that looks like this:
...
- It keeps top-level variables (defined with `var`, `const` or `let`) scoped to your module rather than the global object
